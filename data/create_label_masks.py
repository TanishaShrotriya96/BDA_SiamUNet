...
DISASTERS_OF_INTEREST = ('guatemala-volcano_', 'hurricane-florence_', 'hurricane-harvey_', 
'hurricane-matthew_', 'hurricane-michael_','mexico-earthquake_', 'midwest-flooding_', 'palu-tsunami_', 'santa-rosa-wildfire_', 
'socal-fire_', 'joplin-tornado_','lower-puna-volcano_', 'moore-tornado_','nepal-flooding_', 'pinery-bushfire_',
'portugal-wildfire_', 'sunda-tsunami_', 'tuscaloosa-tornado_','woolsey-fire_')
#('guatemala-volcano_', 'hurricane-florence_', 'hurricane-harvey_', 'mexico-earthquake_', 'midwest-flooding_', 'palu-tsunami_', 'santa-rosa-wildfire_', 'socal-fire_', 'lower-puna-volcano_', 'nepal-flooding_', 'pinery-bushfire_', 'portugal-wildfire_', 'sunda-tsunami_', 'woolsey-fire_')
