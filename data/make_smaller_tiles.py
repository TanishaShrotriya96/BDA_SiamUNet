...
config = {
    'batch_size': 1,
    'data_dir': '../data/',
    'sliced_data_dir': '../splits/final_mdl_all_disaster_splits/',
...
def main():
    ...
    train_loader = DataLoader(xBD_train, batch_size=config['batch_size'], shuffle=False, num_workers=2)
    test_loader = DataLoader(xBD_test, batch_size=config['batch_size'], shuffle=False, num_workers=2)
    val_loader = DataLoader(xBD_val, batch_size=config['batch_size'], shuffle=False, num_workers=2)
